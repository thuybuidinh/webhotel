...
<script src="hotel_asset/assets/jquery.js"></script>

<!-- wow script -->
<script src="hotel_asset/assets/wow/wow.min.js"></script>

<!-- uniform -->
<script src="hotel_asset/assets/uniform/js/jquery.uniform.js"></script>


<!-- boostrap -->
<script src="hotel_asset/assets/bootstrap/js/bootstrap.js" type="text/javascript" ></script>

<!-- jquery mobile -->
<script src="hotel_asset/assets/mobile/touchSwipe.min.js"></script>

<!-- jquery mobile -->
<script src="hotel_asset/assets/respond/respond.js"></script>

<!-- gallery -->
<script src="hotel_asset/assets/gallery/jquery.blueimp-gallery.min.js"></script>


<!-- custom script -->
<script src="hotel_asset/assets/script.js"></script>
